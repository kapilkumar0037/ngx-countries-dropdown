...
@Component({
  selector: 'lib-country-list-standalone',
  templateUrl: './country-list-standalone.component.html',
  styleUrl: './country-list-standalone.component.scss',
  imports: [FormsModule],
...
export class CountryListStandaloneComponent {
